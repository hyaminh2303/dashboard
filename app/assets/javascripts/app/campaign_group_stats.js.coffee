...
#= require_tree ./controllers/campaign_group_stats
...
#= require_tree ./controllers/campaign_pacing_stats
...
$(document).ready ->
  ...
  $(".btn-notify").click (event) ->
    if $(".btn-notify").text() == 'Notify to finance'
      $(".btn-notify").text('Already notified')
      $(".btn-notify")[0].setAttribute('disabled', true)
